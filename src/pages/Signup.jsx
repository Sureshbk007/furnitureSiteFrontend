...
c200 210 489 295 768 227z"
        ...
        <div className="flex flex-col gap-1 mb-5">
          ...
          />
          {formErr?.fullName && (
            <div className="text-red-500 text-sm">*{formErr.fullName}</div>
          )}
        </div>
        <div className="flex flex-col gap-1 mb-5">
          <label htmlFor="" className="block">
        ...
        <div className="flex flex-col gap-1 mb-5">
          ...
          />
          {formErr?.contact && (
            <div className="text-red-500 text-sm">*{formErr.contact}</div>
          )}
        </div>
        <div className="flex flex-col gap-1 mb-5">
        ...
        <button
          className="bg-black text-slate-50 font-bold p-4 rounded-xl w-full my-4 hover:bg-gray-900"
          type="submit"
        >
          Sign Up
        </button>
